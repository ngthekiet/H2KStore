...
@WebServlet(name = "LoadIphone", value = "/loadIphone")
public class LoadIphone extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String quantityProductIphone = request.getParameter("quantityProductIphone");
        int amountIphone = Integer.parseInt(quantityProductIphone);
        response.setContentType("text/html; charset=UTF-8");
        List<Product> productList = ProductServices.getInstance().getNextProduct(iphone, amountIphone);
