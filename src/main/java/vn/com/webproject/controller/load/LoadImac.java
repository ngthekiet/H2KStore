...
@WebServlet(name = "LoadMore", value = "/loadImac")
public class LoadImac extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String imac = "imac";
        String quantityProductImac = request.getParameter("quantityProductImac");
        int amountImac = Integer.parseInt(quantityProductImac);
        response.setContentType("text/html; charset=UTF-8");
        List<Product> productList = ProductServices.getInstance().getNextProduct(imac, amountImac);
